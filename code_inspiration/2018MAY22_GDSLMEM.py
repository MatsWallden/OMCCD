...
ser1.writelines(':CHANnel2:Probe:Type 1\n') # SETS THE PROBE ATTENTUATION 0=1x, 1=10x
ser1.writelines(':CHANnel2:Probe:ratio 0.2\n') # SETS THE PROBE ATTENUATION FACTOR
ser1.writelines(':CHANnel2:SCALe 2.00e-3\n') # SETS THE VERTICAL SCALE
ser1.writelines(':CHANnel2:offset 0\n') #SETS THE OFFSET 
...
#SEND A VALUE AND SEE IF IT COMES BACKC
ser1.flushInput()
